...
class Congrats2Screen extends StatefulWidget {
  const Congrats2Screen({super.key});

  @override
  State<Congrats2Screen> createState() => _Congrats2ScreenState();
}

class _Congrats2ScreenState extends State<Congrats2Screen> with SingleTickerProviderStateMixin {
